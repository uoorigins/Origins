		...
		*/
		...
		private static void OnLogin( LoginEventArgs e )
		{
            ...
            /*if (from is PlayerMobile)
            {
                ...
                if (myAccount.GetTag("Aniv1") != null && myAccount.GetTag("Aniv1") == "true")
                {
                    GiveAniv = false;
                }
                else
		...
		private static void OnLogout( LogoutEventArgs e )
		{
            if (e.Mobile is PlayerMobile)
            {
                ...
                if (system != null && system.m_Players.ContainsKey(e.Mobile))
                    system.RemovePlayer(e.Mobile);
            }
		}
        ...
        {
            //grey
            if (this.Karma < -39 && this.Karma > -110)
            {
                //vs grey
                if (target.Karma < -39 && target.Karma > -110)
                {
