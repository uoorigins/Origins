...
{
    class GoodMageTower : BaseCamp
    {
        public virtual Mobile Mages { get { return new Mage(); } }

        public override CampType Camp { get { return CampType.GoodMage; } }

        [Constructable]
        public GoodMageTower()
            : base(1558)
        {
        }
        ...
        public override void AddComponents()
        {
            ...
            bc.IsPrisoner = true;
            bc.CantWalk = true;
            bc.YellHue = Utility.RandomDyedHue();
        ...
        public GoodMageTower(Serial serial)
            : base(serial)
        {
        }
